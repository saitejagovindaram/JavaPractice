...
public class QueryExecutionUsingQueryRunner {

    public static void main(String[] args) throws IOException, SQLException {
        File configFile=new File("Jsonfiles/Config.json");
        String str= FileUtils.readFileToString(configFile,String.valueOf(StandardCharsets.UTF_8));
        Gson mygson=new Gson();
        Map<String, Object> m1=mygson.fromJson(str, Map.class);
        String s1=(String)m1.get("jdbc_url");
        String s2=(String)m1.get("username");
